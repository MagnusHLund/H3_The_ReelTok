...
{
  internal static class GenerateTokenUtils
  {
    /// <summary>
    ...
    internal static RefreshToken GenerateRefreshToken(Guid userId)
    {
    ...
    internal static AccessToken GenerateAccessToken(Guid userId)
    {
        string secretKey = AppSettingsUtils.GetConfigurationValue("JWTSettings:SecretKey");
        string audience = AppSettingsUtils.GetConfigurationValue("JWTSettings:Audience");
        string issuer = AppSettingsUtils.GetConfigurationValue("JWTSettings:Issuer");
